 ...
 */
public class JFrameNovaAula extends javax.swing.JFrame {
    ...
    private Aula A;
    private String edifici, codi;
    private int capacitat;
    //private String tipus;
    
    public JFrameNovaAula(CtrlPresentacio c) {
        cP = c;
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Introdueix les dades següents per afegir una nova Aula:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        edifici = this.jTextField5.getText();
        if ("".equals(edifici)) {
            JDialog d = new JDialog(this, "Error");
            JLabel l = new JLabel("Has de introduir un edifici!");
            d.add(l);
            d.setSize(200, 100); 
        ...
        codi = this.jTextField6.getText();
        if ("".equals(codi)) {
            JDialog d = new JDialog(this, "Error");
            JLabel l = new JLabel("Has de introduir un codi!");
            d.add(l);
            d.setSize(200, 100); 
            d.setLocationRelativeTo(null);
            d.setVisible(true);
        ...
        String t = this.jTextField7.getText();
        capacitat = Integer.parseInt(t);
        //TO-DO: Tipus?
        A = new Aula(edifici, codi, capacitat, t); //???
